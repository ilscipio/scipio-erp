...
<#if productId?? && product??>
        <@table type="data-list" autoAltRows=true cellspacing="0"> <#-- orig: class="basic-table" -->
          ...
          <@tbody>  
            ...
            <@tr valign="middle">
                <@td><a href="<@ofbizUrl>EditProduct?productId=${(assocToProduct.productId)!}</@ofbizUrl>" class="${styles.link_nav_record_idname!}">${(listToProduct.internalName)!} [${(assocToProduct.productId)!}]</a></@td>
