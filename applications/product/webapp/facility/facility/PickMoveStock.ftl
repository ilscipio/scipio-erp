                ...
                <@tr class="header-row">
                    ...
                    <@tr>
                        <@td colspan="13" align="right">
                            <a href="javascript:document.selectAllForm.submit();" class="${styles.link_action!}">${uiLabelMap.ProductConfirmSelectedMoves}</a>
                        </@td>
                    </@tr>
                    </@tfoot>
            </@table>
            ...
            <input type="hidden" name="facilityId" value="${facilityId!}" />
                ...
                <@field type="generic" label="${uiLabelMap.ProductMoveQuantity}">
                 ...
                 <@field type="submitarea">
                    <a href="javascript:document.quickStockMove.submit();" class="${styles.link_action!}">${uiLabelMap.ProductQuickStockMove}</a>
                </@field>
        </form>
</@section>
