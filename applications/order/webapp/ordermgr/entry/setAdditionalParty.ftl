  ...
  <#if additionalPartyType?? && additionalPartyType != "" && additionalPartyType != "None">
    ...
    <@section>
      ...
      <@field type="submitarea">
        <a href="javascript:document.quickAddPartyForm.submit()" class="${styles.link_run_session!} ${styles.action_update!}">${uiLabelMap.CommonApply}</a>
      </@field>
    </@section>
    ...
    <@section>
      <@heading>3) ${uiLabelMap.OrderPartySelectRoleForParty}</@heading>
        ...
        <@fields type="default-nolabels">
          ...
          <@field type="submitarea">
            <input type="submit" class="${styles.link_run_session!} ${styles.action_add!}" value="${uiLabelMap.CommonAdd} "/>
          </@field>
        </form>
        </@fields>
    </@section>
