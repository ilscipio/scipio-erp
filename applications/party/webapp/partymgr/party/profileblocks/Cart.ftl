           ...
           <@thead>
            ...
            <#list savedCartItems as savedCartItem>
              <@tr>
                ...
                <@td class="button-col"><a href="<@ofbizInterWebappUrl>/catalog/control/EditProduct?productId=${savedCartItem.productId}&amp;externalLoginKey=${requestAttributes.externalLoginKey}</@ofbizInterWebappUrl>" class="${styles.link_nav_info_id!}">${savedCartItem.productId!}</a></@td>
