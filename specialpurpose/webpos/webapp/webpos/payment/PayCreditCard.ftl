...
<div id="payCreditCard" style="display:none">
  <@table type="fields" class="+${styles.table_hint_spacing_small!}" border="0" width="100%"> <#-- orig: class="" --> <#-- orig: cellspacing="" -->
    <@tr>
      <@td colspan="4">&nbsp;</@td>
    </@tr>
    <@tr>
    ...
    <@tr>
      <@td width="100%" align="center" colspan="4">
        ...
        <a id="removeCreditCardTotalPaid" href="javascript:void(0);" class="${styles.link_type_image!} ${styles.action_run_sys!} ${styles.action_remove!}"><img src="/images/collapse.gif"/></a>
      </@td>
    </@tr>
    <@tr>
      <@td width="100%" align="center" colspan="4">
    ...
    <@tr>
      <@td colspan="4" align="center">
        <input type="submit" value="${uiLabelMap.CommonConfirm}" id="payCreditCardConfirm" class="${styles.link_run_sys!} ${styles.action_update!}"/>
        <input type="submit" value="${uiLabelMap.CommonCancel}" id="payCreditCardCancel" class="${styles.link_nav_cancel!}"/>
      </@td>
    </@tr>
    <@tr>
