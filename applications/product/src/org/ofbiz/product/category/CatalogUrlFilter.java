 ...
 * <p>
 * Cato: FIXME?: There is a limitation in this filter that the trail will only be set to the product or category's
...
public class CatalogUrlFilter extends ContextFilter {
    ...
    /**
     * Cato: Returns appropriate trail elements for a category or ID (abstraction method), checked against current trail,
    ...
    /**
     * Cato: Tries to see if the passed product or category can be integrated in the current/given trail.
