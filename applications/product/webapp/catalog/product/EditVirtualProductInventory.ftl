        ...
        <@table type="data-list" autoAltRows=true cellspacing="0"> <#-- orig: class="basic-table" -->
          ...
          <@tbody>
            <#list variantInventorySummaries as variantSummary>
              <@tr valign="middle">
                <@td><a href="<@ofbizUrl>EditProductInventoryItems?productId=${variantSummary.productId}</@ofbizUrl>" class="${styles.link_nav_record_id!}">${variantSummary.productId}</a></@td>
                    <#list featureTypeIds as featureTypeId>
