            ...
            <#if parameters.transactionId == leaveFeedback.transactionID && parameters.itemId == leaveFeedback.itemID>
                <#if role == "buyer">
                    ...
                    <@tr alt=(row == "alternate-row") style="border:#eeeeee solid thin">
                        ...
                        <@td>
                            Buyer:<a target="_blank" href="http://myworld.sandbox.ebay.com/${leaveFeedback.userID}" class="${styles.link_nav_record_id!}">${leaveFeedback.userID}</a>
                        </@td>
                    </@tr>
                <#else>
                    <#assign feedbackCounter = feedbackCounter + 1>
                    ...
                    <@tr alt=(row == "alternate-row") style="border:#eeeeee solid thin">
                        ...
                        <@td>
                            Seller:<a target="_blank" href="http://myworld.sandbox.ebay.com/${leaveFeedback.userID}" class="${styles.link_nav_record_id!}">${leaveFeedback.userID}</a>
                        </@td>
                    </@tr>
                </#if>
            </#if>
