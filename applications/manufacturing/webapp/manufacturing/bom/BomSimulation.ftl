        ...
        <@tbody>
          <#list productsData as productData>
            ...
            <@tr valign="middle">
              ...
              <#else>
              <@td align="right"><a href="<@ofbizInterWebappUrl>/catalog/control/EditProductCosts?productId=${node.product.productId}${StringUtil.wrapString(externalKeyParam)}</@ofbizInterWebappUrl>" class="${styles.link_nav!} ${styles.action_update!}">NA</a></@td>
              </#if>
