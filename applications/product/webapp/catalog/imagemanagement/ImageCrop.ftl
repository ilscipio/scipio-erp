...
if (imageName != "") {
    ...
    jQuery('#ImageCropping tbody').append("<tr><td><a class='button tiny' title=' ' href='/catalog/control/ListImageManage?productId="+productId+"'>${uiLabelMap.CommonCancel}</a></td></tr>");
}
