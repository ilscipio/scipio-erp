...
<@section title="${uiLabelMap.OrderOrderItems}">
  <#if (shoppingCartSize > 0)>
    <form method="post" action="<@ofbizUrl>modifycart</@ofbizUrl>" name="cartform">
      ...
      <@table type="data-complex" autoAltRows=true class="${styles.table!}" cellspacing="0" cellpadding="1" border="0">
        <@thead>
        <@tr>
          <@th>&nbsp;</@th>
          <@th colspan="2">
        ...
        <#list shoppingCart.items() as cartLine>
          ...
          <@tr valign="top">
            <@td>&nbsp;</@td>
            <@td>
          <@table type="fields" inheritAltRows=true class="${styles.table!}" border="0">
          <@tr><@td colspan="2">
            ...
            <@tr>
              <@td colspan="2">
               <@table type="fields" class="${styles.table!}" inheritAltRows=true border="0" cellpadding="0" cellspacing="0" width="100%">
               <@tr>
                <@td>
