  ...
  <@row>
    <@cell>
      <@section title=sectionTitle>
          <@menu type="button">
            <#-- Cato: TODO: Hopefully can remove link to the old one when this is over... -->
            <@menuitem type="link" href=makeOfbizUrl("setCustomer") class="+${styles.action_run_session!} ${styles.action_continue!}" text="${uiLabelMap.OrderCheckout} (OLD)" />
            <@menuitem type="link" href=makeOfbizUrl("anoncheckoutoptions") class="+${styles.action_run_session!} ${styles.action_continue!}" text="${uiLabelMap.OrderCheckout} (NEW)" />
