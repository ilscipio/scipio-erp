            ...
            <@td class="button-col">
              <#if entity.viewEntity == 'Y'>
                <#if entity.entityPermissionView == 'Y'>
                  ...
                  <a href="<@ofbizUrl>FindGeneric?entityName=${entity.entityName}&amp;find=true&amp;VIEW_SIZE=${getPropertyValue("webtools", "webtools.record.viewSize.default")!50}&amp;VIEW_INDEX=0</@ofbizUrl>">${uiLabelMap.WebtoolsAll}</a>
                </#if>
              <#else>
                ...
                <#if entity.entityPermissionView == 'Y'>
                  ...
                  <a href="<@ofbizUrl>FindGeneric?entityName=${entity.entityName}&amp;find=true&amp;VIEW_SIZE=${getPropertyValue("webtools", "webtools.record.viewSize.default")!50}&amp;VIEW_INDEX=0</@ofbizUrl>" title="${uiLabelMap.WebtoolsFindAllRecords}">${uiLabelMap.WebtoolsAll}</a>
                </#if>
              </#if>
            </@td>
            <#if right_col>
