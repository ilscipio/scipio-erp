...
<@tr>
  <@td width="26%" align="right" valign="middle">${uiLabelMap.AccountingCompanyNameOnAccount}</@td><@td width="5">&nbsp;</@td>
...
<@tr>
  <@td width="26%" align="right" valign="middle">${uiLabelMap.AccountingAccountType}</@td><@td width="5">&nbsp;</@td>
  <@td width="74%">
