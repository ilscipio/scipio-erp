    ...
    <@section title=uiLabelMap.ProductUploadImage>
        <form method="post" enctype="multipart/form-data" action="<@ofbizUrl>UploadProductImage?productId=${productId}&amp;upload_file_type=original</@ofbizUrl>" name="imageUploadForm">
          <@fields type="default-nolabelarea">
            ...
            <@field type="generic">
                <@field type="radio" name="upload_file_type_bogus" value="small" onClick="setUploadUrl('${escapePart(makeOfbizUrl('UploadProductImage?productId=${productId}&upload_file_type=small'), 'js')}');" label=uiLabelMap.CommonSmall/>
                <@field type="radio" name="upload_file_type_bogus" value="medium" onClick="setUploadUrl('${escapePart(makeOfbizUrl('UploadProductImage?productId=${productId}&upload_file_type=medium'), 'js')}');" label=uiLabelMap.CommonMedium/>
                <@field type="radio" name="upload_file_type_bogus" value="large" onClick="setUploadUrl('${escapePart(makeOfbizUrl('UploadProductImage?productId=${productId}&upload_file_type=large'), 'js')}');" label=uiLabelMap.CommonLarge/>
                <@field type="radio" name="upload_file_type_bogus" value="detail" onClick="setUploadUrl('${escapePart(makeOfbizUrl('UploadProductImage?productId=${productId}&upload_file_type=detail'), 'js')}');" label=uiLabelMap.CommonDetail/>
                <@field type="radio" name="upload_file_type_bogus" value="original" checked=true onClick="setUploadUrl('${escapePart(makeOfbizUrl('UploadProductImage?productId=${productId}&upload_file_type=original'), 'js')}');" label=uiLabelMap.ProductOriginal/>
            </@field>
