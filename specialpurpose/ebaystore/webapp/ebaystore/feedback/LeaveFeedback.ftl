            ...
            <#if parameters.transactionId == leaveFeedback.transactionID && parameters.itemId == leaveFeedback.itemID>
                <#if role == "buyer">
                    ...
                    <@tr alt=(row == "alternate-row") style="border:#eeeeee solid thin">
                        ...
                        <@td>
                            Buyer:<a target="_blank" href="http://myworld.sandbox.ebay.com/${leaveFeedback.userID}" class="${styles.link_nav_info_id!}">${leaveFeedback.userID}</a>
                        </@td>
                    </@tr>
                <#else>
                    <#assign feedbackCounter = feedbackCounter + 1>
                    ...
                    <@tr alt=(row == "alternate-row") style="border:#eeeeee solid thin">
                            ...
                            <@table type="fields" class="+${styles.table_spacing_tiny_hint!}"> <#-- orig: class="" --> <#-- orig: cellspacing="" -->
                                ...
                                <@tr id="itemOption${feedbackCounter}" style="display:none;border:#eeeeee solid thin;text-indent:10px">
                                    <@td colspan="2">
                                        ...
                                        <@table type="fields" class="+answers" width="100%"> <#-- orig: class="answers" --> <#-- orig: cellspacing="0" --> <#-- orig: cellpadding="0" --> <#-- orig: border="0" -->
                                            <@tbody>
                                                <@tr>
                        ...
                        <@td>
                            Seller:<a target="_blank" href="http://myworld.sandbox.ebay.com/${leaveFeedback.userID}" class="${styles.link_nav_info_id!}">${leaveFeedback.userID}</a>
                        </@td>
                    </@tr>
                </#if>
            </#if>
