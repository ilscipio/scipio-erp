...
<#macro cmsObjectExportFormMenuItem presetConfigName="" pkField="" pkValue="" args...>
  <@menuitem type="generic">
    <@modal id="modal_export_object" label=uiLabelMap.CommonExport anchorClass="+${styles.menu_button_item_link!} ${styles.action_nav!} ${styles.action_show!}">
...
<#macro cmsCopyMenuItem target title args...>
  <@menuitem type="generic">
    <@modal id="modal_copy_object" label=uiLabelMap.CommonCopy anchorClass="+${styles.menu_button_item_link!} ${styles.action_nav!} ${styles.action_copy!}">
