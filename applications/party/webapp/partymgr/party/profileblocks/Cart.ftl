           ...
           <@thead>
            ...
            <#list savedCartItems as savedCartItem>
              <@tr>
                ...
                <@td class="button-col"><a href="/catalog/control/EditProduct?productId=${savedCartItem.productId}&amp;externalLoginKey=${requestAttributes.externalLoginKey}" class="${styles.link_id!}">${savedCartItem.productId!}</a></@td>
