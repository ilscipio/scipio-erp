      ...
      <@fields type="generic"> <#-- no auto label areas or fancy things -->
        ...
        <#else>
          ...
          <@field type="submitarea">
            <input type="submit" value="${uiLabelMap.CommonFind}" class="${styles.link_action_sys!} ${styles.action_find!}" />
          </@field>
      </@fields>
    </form>
    ...
    <form name="advancedsearchform" id="keywordsearchbox_advancedsearchform" method="post" action="<@ofbizUrl>advancedsearch</@ofbizUrl>">
      <@fieldset title="${uiLabelMap.CommonAdvancedSearch}" collapsed=true>
        ...
        <#else>
          ...
          <@field type="submitarea">
            <input type="submit" value="${uiLabelMap.ProductAdvancedSearch}" class="${styles.link_action_sys!} ${styles.action_find!}" />
          </@field>
      </@fieldset>
    </form>
</@section>