...
<form name="editContentTree" action="<#if parameters.rename?has_content><@ofbizUrl>updateDocumentTree</@ofbizUrl><#else><@ofbizUrl>addDocumentToTree</@ofbizUrl></#if>" method="post">
    ...
    <#if parameters.rename?has_content>
        ...
        <br /><a class="${styles.link_action_sys!} ${styles.action_update!}" href="javascript:document.editContentTree.submit();">${uiLabelMap.ContentRenameFolder}</a><a class="${styles.link_nav_cancel!}" href="<@ofbizUrl>navigateContent</@ofbizUrl>">${uiLabelMap.CommonCancel}</a>
    <#else>
        ...
        <br /><a class="${styles.link_action_sys!} ${styles.action_add!}" href="javascript:document.editContentTree.submit();">${uiLabelMap.CommonCreate}</a><a class="${styles.link_nav_cancel!}" href="<@ofbizUrl>navigateContent</@ofbizUrl>">${uiLabelMap.CommonCancel}</a>
    </#if>
