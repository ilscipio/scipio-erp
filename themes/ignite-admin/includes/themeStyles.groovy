...
context.styles = [
  ...
  /* Generic */
    "framework" : "bootstrap",
    "customSideBar" : true,
    "turboLinks" : false, // Experimental: Replaces side-navigation anchors with ajax requests (requires partial renderer)
    "disabled" : "disabled",
    "active" : "active",
    "selected" : "selected",
    "button" : "btn",
    ...
    "postfix" : "input-group-text",
    "postfixarea" : "input-group-append",
    "hidden" : "hide",
    "icon" : "fa",
    "icon_prefix" : "fa fa-",
  ...
  /* Menus */
    ...
    "menu_button" : "menu-type-button btn-group",
    ...
    "menu_button_item_link" : "btn btn-default",
    ...
    "menu_button_dropdown_title" : "btn btn-sm dropdown-toggle",
  ...
  /* Generic action styles */
    ...
    "action_modify" : "btn action-modify",
    "action_add" : "btn action-modify action-add btn-success",
    "action_update" : "btn action-modify action-update btn-default",
    "action_remove" : "btn action-modify action-remove btn-danger",
    "action_clear" : "btn action-modify action-clear btn-danger",
    "action_move" : "btn action-modify action-move",
    "action_copy" : "btn action-modify action-copy",
    "action_configure" : "btn action-modify action-configure",
    "action_begin" : "btn action-modify action-begin",
    "action_reset" : "btn action-modify action-reset",
    "action_hold" : "btn action-modify action-hold btn-warning",
    "action_terminate" : "btn action-modify action-terminate btn-danger",
    "action_complete" : "btn action-modify action-complete",
    "action_updatestatus" : "btn action-modify action-updatestatus btn-warning",
    "action_import" : "btn action-modify action-import",
    "action_transfer" : "btn action-modify action-transfer",
    "action_send" : "btn action-modify action-send",
    "action_receive" : "btn action-modify action-receive",
    "action_sync" : "btn action-modify action-sync",
    "action_register" : "btn action-modify action-login",
    "action_login" : "btn action-modify action-login",
    "action_logout" : "btn action-modify action-logout",
    "action_continue" : "btn action-modify action-continue",
    
    /* Specific read-only actions (may or retrieve or submit data for analysis without changing state meaningfully) */
    "action_readonly" : "btn action-readonly",
    "action_read" : "btn action-readonly action-read",
    "action_find" : "btn action-readonly action-read action-find",
    "action_view" : "btn action-readonly action-read action-view",
    "action_export" : "btn action-readonly action-read action-export",
    
    "action_visibility" : "btn action-readonly action-visibility",
    "action_show" : "btn action-readonly action-visibility action-show",
    "action_hide" : "btn action-readonly action-visibility action-hide",
    "action_close" : "btn action-readonly action-close",
    "action_select" : "btn action-readonly action-select",
    "action_reload" : "btn action-readonly action-reload",
    "action_verify" : "btn action-readonly action-verify",

    /* Misc action flags (fragments) */
    "action_external" : "btn action-external",

    "action_primary" : "btn action-primary",
    "action_primary_inline" : "btn action-primary-inline action-inline",
    "action_secondary" : "btn action-secondary",
    "action_secondary_inline" : "btn action-secondary-inline action-inline",
    
    "action_importance_low" : "btn action-importance-low",
    "action_importance_normal" : "btn action-importance-normal",
    "action_importance_high" : "btn action-importance-high",
    
    "action_inline" : "btn action-inline",
    
    
    /* Convenience shorthands */
    "action_nav_cancel" : "btn action-nav action-cancel btn-danger",
    "action_nav_sys_cancel" : "btn action-nav action-scope-sys action-cancel btn-danger",
    "action_nav_session_cancel" : "btn action-nav action-scope-session action-cancel btn-danger",
    "action_nav_local_cancel" : "btn action-nav action-scope-local action-cancel btn-danger",
    "action_run_sys_cancel" : "btn action-run action-scope-sys action-cancel btn-danger",
    "action_run_session_cancel" : "btn action-run action-scope-session action-cancel btn-danger",
    "action_run_local_cancel" : "btn action-run action-scope-local action-cancel btn-danger",
  ...
  /* Link styles (standalone/full) */
    ...
    "link_run_sys" :                "link-type-text action-run action-scope-sys action-primary btn btn-success",
    ...
    "link_run_sys_cancel" :         "link-type-text action-run action-scope-sys action-primary action-cancel btn btn-danger",
    "link_run_sys_cancel_long" :    "link-type-text action-run action-scope-sys action-primary action-cancel link-long",
    "link_run_sys_info" :           "link-type-text action-run action-scope-sys action-secondary btn btn-info",
    "link_run_sys_info_long" :      "link-type-text action-run action-scope-sys action-secondary link-long",
    "link_run_session" :            "link-type-text action-run action-scope-session action-primary btn btn-success",
    ...
    "link_run_session_cancel" :     "link-type-text action-run action-scope-session action-primary action-cancel btn btn-danger",
    "link_run_session_cancel_long" :"link-type-text action-run action-scope-session action-primary action-cancel link-long",
    "link_run_session_info" :       "link-type-text action-run action-scope-session action-secondary btn btn-info",
    "link_run_session_info_long" :  "link-type-text action-run action-scope-session action-secondary link-long",
    "link_run_local" :              "link-type-text action-run action-scope-local action-primary btn btn-success",
    ...
    "link_run_local_cancel" :       "link-type-text action-run action-scope-local action-primary action-cancel btn btn-danger",
    ...
    "link_nav" :                    "link-type-text action-nav action-primary btn btn-sm btn-primary",
    ...
    "link_nav_cancel" :             "link-type-text action-nav action-primary action-cancel btn btn-sm btn-danger",
...
/* Pagination */
  ...
  "pagination_link":"page-link",
  "pagination_dots":"page-item disabled",
