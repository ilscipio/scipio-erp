            ...
            <#list shipGroups as group>
              ...
              <form method="post" action="#" name="editgroupform${groupIdx}">
                ...
                <@tr>
                  ...
                  <@td><input type="button" class="smallSubmit ${styles.button_default!}" value="${uiLabelMap.CommonSave}" onclick="javascript:submitForm(document.editgroupform${groupIdx}, 'SV', null);"/></@td>
                </@tr>
                ...
                <@td>
                  <div class="tabletext">
                    <#if cartLine.getProductId()??>
                      ...
                      <a href="<@ofbizUrl>product?product_id=${cartLine.getProductId()}</@ofbizUrl>" class="${styles.button_default!}">${cartLine.getProductId()} -
...
<@menu type="button">
  <@menuitem type="link" ofbizHref="updateCheckoutOptions/showcart" text="${uiLabelMap.OrderBacktoShoppingCart}" />
  <@menuitem type="link" ofbizHref="setBilling" text="${uiLabelMap.CommonContinue}" />
</@menu>
