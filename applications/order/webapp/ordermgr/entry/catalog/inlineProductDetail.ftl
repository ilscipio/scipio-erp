...
<@table type="fields" border="0" cellpadding="2" cellspacing="0" width="100%">
  <@tr>
    <@td align="left" valign="top" width="0">
      ...
      <#if productLargeImageUrl?string?has_content>
        ...
        <a href="javascript:popupDetailInline('${inlineCounter}');" class="${styles.action_run_sys!} ${styles.action_view!}"><img src="<@ofbizContentUrl>${contentPathPrefix!}${productLargeImageUrl!}</@ofbizContentUrl>" name="mainImage${inlineCounter}" vspace="5" hspace="5" class="cssImgLarge" align="left" alt="" /></a>
      </#if>
    </@td>
    ...
    <#--    <@heading>${productContentWrapper.get("PRODUCT_NAME", "html")!}</@heading>  -->
      ...
      <#if variantSample?? && 0 < variantSample.size()>
        ...
        <p>&nbsp;</p>
        <@table type="fields" cellspacing="0" cellpadding="0"> <#- orig: class="" ->
          <@tr>
            <#assign maxIndex = 7>
            <#assign indexer = 0>
            <#list imageKeys as key>
              ...
              <#if swatchProduct?has_content && indexer < maxIndex>
                ...
                <@td align="center" valign="bottom">
                  <a href="javascript:getListInline('${inlineCounter}', 'FT${inlineCounter}${featureOrderFirst}','${indexer}',1);" class="${styles.action_run_local!} ${styles.action_select!}"><img src="<@ofbizContentUrl>${contentPathPrefix!}${imageUrl}</@ofbizContentUrl>" border="0" width="60" height="60" alt="" /></a>
                  <br />
