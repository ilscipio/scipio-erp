...
<@section title="${uiLabelMap.PageTitleRequestItems}">
    ...
    <#if custRequestItemList.custRequestItemSeqId?has_content>
        <@tr>
            <@td>
              <a href="<@ofbizUrl>requestitem?custRequestId=${custRequestItemList.custRequestId}&amp;custRequestItemSeqId=${custRequestItemList.custRequestItemSeqId}</@ofbizUrl>" class="${styles.link_nav_record_id!}">${custRequestItemList.custRequestItemSeqId}</a>
            </@td>
            <@td colspan="2">
            ...
            <@td colspan="1" align="right" valign="top" width="50%" nowrap="nowrap" style="background-color:white; vertical-align: top;">
                ...
                <a href="<@ofbizUrl>requestitemnotes?custRequestId=${custRequestItemList.custRequestId}&amp;custRequestItemSeqId=${custRequestItemList.custRequestItemSeqId}</@ofbizUrl>" class="${styles.link_action_sys!} ${styles.action_add!}">${uiLabelMap.OrderAddNote}</a>
            </@td>
        </@tr>
    </#if>
    </#list>
