...
<div style="border-bottom: 1px solid #ccc; margin-bottom: 20px">
    <p>
        <b>${uiLabelMap.AccountingAccountNumber}:</b> <a href="/accounting/control/EditFinAccount?finAccountId=${ownedFinAccount.finAccountId}${StringUtil.wrapString(externalKeyParam)}"
             class="smallSubmit ${styles.button_default!}">${ownedFinAccount.finAccountId}</a>
    ...
    <@table type="data-list" id="fa-transactions" cellspacing="0" cellpadding="2"> <#-- orig: class="basic-table" -->
        <@thead>
            <@tr class="header-row">
...
<#if ownedFinAccountAuthList?has_content>
    <div style="border-bottom: 1px solid #ccc; margin-bottom: 20px">
        <@table type="data-list" id="fa-authorizations" cellspacing="0" cellpadding="2"> <#-- orig: class="basic-table" -->
            <@thead>
                <@tr class="header-row">
