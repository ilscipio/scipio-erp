...
public class CCServicesTest extends OFBizTestCase {
    ...
    public void testAuth() throws Exception {
        ...
        try {
            ...
            if ((Boolean.FALSE).equals(result.get("authResult"))) { // returnCode ok? // SCIPIO: 2018-09-26: TODO: REVIEW: upstream changed this to Boolean.TRUE, but seems like should be false, no?
