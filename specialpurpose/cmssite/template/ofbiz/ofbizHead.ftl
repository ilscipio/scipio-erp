...
<head>
    ...
    <link rel="stylesheet" href="<@ofbizContentUrl>/ofbiz/images/ofbws.css</@ofbizContentUrl>" type="text/css"/>
    ...
    <link rel="shortcut icon" href="<@ofbizContentUrl>/ofbiz/images/ofbiz.ico</@ofbizContentUrl>"/>
</head>
