...
<#assign sprint = delegator.findOne("WorkEffort", {"workEffortId":parameters.get("sprintId")}, false)! />
...
<#assign members = delegator.findByAnd("WorkEffortPartyAssignment", {"workEffortId":parameters.get("sprintId")}, null, false)/>
<#if (members.size() > 0)>
