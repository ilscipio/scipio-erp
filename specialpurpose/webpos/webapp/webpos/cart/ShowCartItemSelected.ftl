...
<#if cartLineIndex?? && cartLineIndex?has_content>
  ...
  <#if isInteger>
    ...
    <#if cartLine?? && cartLine?has_content>
      ...
      <a href="javascript:void(0);" id="incrementQuantity" class="${styles.action_run_session!} ${styles.action_add!}"><img src="/images/expand.gif"/></a>
      <a href="javascript:void(0);" id="decrementQuantity" class="${styles.action_run_session!} ${styles.action_remove!}"><img src="/images/collapse.gif"/></a>
      <br/>
