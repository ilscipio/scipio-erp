...
<@section title="${uiLabelMap.PageTitleEditShipmentItems}">
        ...
        <#list shipmentItemDatas as shipmentItemData>
            ...
            <@tr valign="middle" alt=alt_row>
                ...
                <@td colspan="2"><a href="/catalog/control/EditProduct?productId=${shipmentItem.productId!}" target="_blank" class="${styles.link_nav_info_idname!}">${shipmentItem.productId!} - ${(product.internalName)!}</a></@td>
            ...
            <#list orderShipments as orderShipment>
                <@tr valign="middle" alt=alt_row>
                    <@td>&nbsp;</@td>
                    <@td><span>${uiLabelMap.ProductOrderItem}</span> <a href="/ordermgr/control/orderview?orderId=${orderShipment.orderId!}" class="${styles.link_nav_info_id!}">${orderShipment.orderId!}</a> ${orderShipment.orderItemSeqId!}</@td>
                    <@td>&nbsp;</@td>
            ...
            <#list itemIssuances as itemIssuance>
                <@tr valign="middle" alt=alt_row>
                    <@td>&nbsp;</@td>
                    <@td><span>${uiLabelMap.ProductOrderItem}</span> <a href="/ordermgr/control/orderview?orderId=${itemIssuance.orderId!}" target="_blank" class="${styles.link_nav_info_id_long!}">${itemIssuance.orderId!} -  ${itemIssuance.orderItemSeqId!}</a></@td>
