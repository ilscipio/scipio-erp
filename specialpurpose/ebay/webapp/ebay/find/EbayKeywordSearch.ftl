...
<@section title="${uiLabelMap.ProductSearchProducts}, ${uiLabelMap.ProductSearchFor}:">
    ...
    <#if !productIds?has_content>
      <div><@commonMsg type="result-norecord">${uiLabelMap.ProductNoResultsFound}.</@commonMsg></div>
    </#if>
    ...
    <#if productIds?has_content>
      ...
      <form method="post" name="products" action="">
        <fieldset>
          ...
          <@table type="data-list" autoAltRows=true firstRowAlt=true class="+border-top border-bottom ${styles.table_spacing_tiny_hint!}"> <#-- orig: class="basic-table border-top border-bottom" --> <#-- orig: cellspacing="" -->
