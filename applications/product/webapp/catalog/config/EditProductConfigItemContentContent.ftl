...
<#if contentId?has_content>
  <@menuitem type="link" href="/content/control/gotoContent?contentId=${contentId}" target='_blank' text="${uiLabelMap.ProductContent} ${uiLabelMap.CommonPage}" class="+${styles.action_nav!}" />
</#if>
</@menu>
<br />
