          ...
          <@td align="right" valign="top" width="15%">
            <#if note.internalNote! == "N">
                ...
                <form name="privateNotesForm_${note_index}" method="post" action="<@ofbizUrl>updateOrderNote</@ofbizUrl>">
                  ...
                  <a href="javascript:document.privateNotesForm_${note_index}.submit()" class="${styles.link_action!}">${uiLabelMap.OrderNotesPrivate}</a>
                </form>
            </#if>
            <#if note.internalNote! == "Y">
                ...
                <form name="publicNotesForm_${note_index}" method="post" action="<@ofbizUrl>updateOrderNote</@ofbizUrl>">
                  ...
                  <a href="javascript:document.publicNotesForm_${note_index}.submit()" class="${styles.link_action!}">${uiLabelMap.OrderNotesPublic}</a>
                </form>
            </#if>
          </@td>
        </@tr>
