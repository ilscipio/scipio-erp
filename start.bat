...
cd %OFBIZ_HOME%
echo on
"%JAVA_HOME%\bin\java" -Xms128M -Xmx3512M -Xdebug -Xnoagent -Dsolr.solr.home=applications/solr/ -Dsolr.log.dir=runtime/logs/solr/ -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=8091 -jar ofbiz.jar
echo off
