        ...
        <@tr>
          <@td align="center">
            <#if person?has_content>
              <div><a href="${customerDetailLink}${partyId}${rawString(externalKeyParam!)}" class="${styles.link_nav_info_name!}">${person.firstName!}&nbsp;${person.lastName!}</a></div>
            <#elseif partyGroup?has_content>
              <div class="tabletext"><a href="${customerDetailLink}${partyId}${rawString(externalKeyParam!)}" class="${styles.link_nav_info_name!}">${partyGroup.groupName!}</a></div>
            </#if>
