...
<#assign logo><img src="<@ofbizContentUrl><#if headerImageUrl?has_content>${rawString(headerImageUrl)}<#else>/images/cato/cato-logo-small.png</#if></@ofbizContentUrl>"/></#assign>
