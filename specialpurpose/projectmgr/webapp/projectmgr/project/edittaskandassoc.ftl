      ...
      <#else>
        ...
        <@field type="select" label=uiLabelMap.CommonStatus name="currentStatusId">
          <#if task??>
            ...
            <#assign statusValidChangeToDetailList = delegator.findByAnd("StatusValidChangeToDetail", {"statusId":currentStatus.currentStatusId}, null, false)>
          ...
          <#else>
            <#assign statusItemGenrals = delegator.findByAnd("StatusItem", {"statusTypeId":"CALENDAR_STATUS"}, null, false)>
            <#assign statusItemTasks = delegator.findByAnd("StatusItem", {"statusTypeId":"TASK_STATUS"}, null, false)>
            <#assign statusItemEvents = delegator.findByAnd("StatusItem", {"statusTypeId":"EVENT_STATUS"}, null, false)>
