...
<div style="border-bottom: 1px solid #ccc; margin-bottom: 20px">
    ...
    <@table type="data-list" id="fa-transactions" class="${styles.table!}" cellspacing="0" cellpadding="2">
        <@thead>
            <@tr class="header-row">
...
<#if ownedFinAccountAuthList?has_content>
    <div style="border-bottom: 1px solid #ccc; margin-bottom: 20px">
        <@table type="data-list" id="fa-authorizations" class="${styles.table!}" cellspacing="0" cellpadding="2">
            <@thead>
                <@tr class="header-row">
