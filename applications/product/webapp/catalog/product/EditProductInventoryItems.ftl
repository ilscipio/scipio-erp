            ...
            <#list productInventoryItems as inventoryItem>
               ...
               <#if showEmpty || (inventoryItem.inventoryItemTypeId! == "SERIALIZED_INV_ITEM" && inventoryItem.statusId! != "INV_DELIVERED")
                    ...
                    <#if curInventoryItemType??>
                        <@tr valign="middle">
                            <@td><a href="/facility/control/EditInventoryItem?inventoryItemId=${(inventoryItem.inventoryItemId)!}${StringUtil.wrapString(externalKeyParam)}" class="${styles.link_nav_record_id!}">${(inventoryItem.inventoryItemId)!}</a></@td>
                            ...
                            <#elseif inventoryItem.facilityId??>
                                <@td>${uiLabelMap.ProductFacilityLetter}:&nbsp;<a href="/facility/control/EditFacility?facilityId=${inventoryItem.facilityId}${StringUtil.wrapString(externalKeyParam)}" class="${styles.link_nav_record_id!}">${inventoryItem.facilityId}</a></@td>
                            <#elseif (inventoryItem.containerId)??>
                                <@td>${uiLabelMap.ProductContainerLetter}:&nbsp;<a href="<@ofbizUrl>EditContainer?containerId=${inventoryItem.containerId }</@ofbizUrl>" class="${styles.link_nav_record_id!}">${inventoryItem.containerId}</a></@td>
                            <#else>
                                <@td>&nbsp;</@td>
                            </#if>
