...
<#if orderHeader?has_content>
  ...
  <@section title="${uiLabelMap.OrderOrderItems}" menuContent=menuContent>
        ...
        <@table type="data-complex" class="+order-items" cellspacing="0"> <#-- orig: class="basic-table order-items" -->
                                ...
                                <#if returns?has_content>
                                  <#list returns as returnItem>
                                    ...
                                    <#if returnHeader.statusId != "RETURN_CANCELLED">
                                                ...
                                                ${uiLabelMap.CommonNbr}<a href="<@ofbizUrl>returnMain?returnId=${returnItem.returnId}</@ofbizUrl>" class="${styles.link_id!}">${returnItem.returnId}</a>
                                    </#if>
                                  </#list>
                                </#if>
                                   </@modal>
