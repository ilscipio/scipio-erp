...
NOTE: All @field arg defaults can be overridden by the @fields fieldArgs argument.
  ...
  * Parameters *
    * General *
    ...
    name            = field name
    value           = field value
    totalColumns            = Total number of columns spanned by the outer container, including label area, widget and postfix.
    widgetPostfixColumns    = Number of grid columns to use as size for widget + postfix area (combined).
...
<#assign field_defaultArgs = {
  ...
  "tooltip":"", "totalColumns":"", "widgetPostfixColumns":"", "widgetPostfixCombined":"", "norows":false, "nocells":false, "container":"", "containerId":"", "containerClass":"",
...
<#macro field args={} inlineArgs...> 
  ...
  <@field_markup_container type=type totalColumns=totalColumns widgetPostfixColumns=widgetPostfixColumns widgetPostfixCombined=widgetPostfixCombined postfix=postfix postfixSize=postfixSize 
...
<#function getDefaultFieldGridStyles args={} catchArgs...>
  ...
  <#if !widgetPostfixColumns?has_content>
    <#if labelArea && labelInRow>
      <#local widgetPostfixColumns = totalColumns - 2>
    <#else>
