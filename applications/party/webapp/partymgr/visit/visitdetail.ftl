...
<@section title="${uiLabelMap.PartyVisitDetail}">
      <@table type="fields" cellspacing="0"> <#-- orig: class="basic-table" -->
        ...
        <@tr>
          ...
          <@td><a href="http://uptime.netcraft.com/up/graph/?site=${visit.serverIpAddress!}" target="_blank" class="${styles.link_url!}">${visit.serverIpAddress!}</a> / <a href="http://uptime.netcraft.com/up/graph/?site=${visit.serverIpAddress!}" target="_blank" class="${styles.link_url!}">${visit.serverHostName!}</a></@td>
        </@tr>
        <@tr>
          <@td>${uiLabelMap.PartyClient}</@td>
          <@td><a href="http://ws.arin.net/cgi-bin/whois.pl?queryinput=${visit.clientIpAddress!}" target="_blank" class="${styles.link_url!}">${visit.clientIpAddress!}</a> / <a href="http://www.networksolutions.com/cgi-bin/whois/whois?STRING=${visit.clientHostName!}&amp;SearchType=do" target="_blank" class="${styles.link_url!}">${visit.clientHostName!}</a></@td>
        </@tr>
        <@tr>
