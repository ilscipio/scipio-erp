          ...
          <@thead>
            ...
            <#list relations as relation>
                <@tr>
                    ...
                    <@td class="button-col"><a href="<@ofbizUrl>FindGeneric?entityName=${relation.relEntityName}&amp;find=true&amp;VIEW_SIZE=${getPropertyValue("webtools", "webtools.record.viewSize.default")!50}&amp;VIEW_INDEX=0</@ofbizUrl>">${relation.relEntityName}</a></@td>
                    <@td>${relation.type}</@td>
