...
<#if orderHeader.orderName?has_content>
    <tr>
        <td>${uiLabelMap.OrderOrderName}
        </td>
        <td colspan="3">${orderHeader.orderName}</td>
    </tr>    
</#if>
<tr>
    <td scope="row">${uiLabelMap.OrderStatusHistory}</td>
    <td colspan="3">
...
<tr>
    <td scope="row">${uiLabelMap.OrderDateOrdered}</td>
    <td colspan="3">
...
<#if orderHeader.internalCode?has_content>
    ...
    <tr>
        <td scope="row">${uiLabelMap.OrderSalesChannel}</td>
        <td colspan="3">
...
<#if productStore?has_content>
    <tr>
        <td scope="row">${uiLabelMap.OrderProductStore}</td>
        <td colspan="3">
    ...
    <tr>
        <td scope="row">${uiLabelMap.OrderOriginFacility}</td>
        <td colspan="3">
    ...
    <tr>
        <td scope="row">${uiLabelMap.CommonCreatedBy}</td>
        <td colspan="3">
...
<#if (orderItem.cancelBackOrderDate)??>
    <tr>
        <td scope="row">${uiLabelMap.FormFieldTitle_cancelBackOrderDate}</td>
        <td colspan="3">
...
<#if distributorId??>
    <tr>
        <td scope="row">${uiLabelMap.OrderDistributor}</td>
        <td colspan="3">
