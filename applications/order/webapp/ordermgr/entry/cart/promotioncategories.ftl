    ...
    <@section title="${uiLabelMap.OrderPromotionCategories}">
        <#if productPromoCategoryIncludeList?has_content>
          ...
          <#list productPromoCategoryIncludeList as productPromoCategory>
            ...
            <div>
                -&nbsp;<a href="<@ofbizUrl>category/~category_id=${productPromoCategory.productCategoryId}</@ofbizUrl>" class="${styles.button_default!}">${(productCategory.description)?default(productPromoCategory.productCategoryId)}</a>
