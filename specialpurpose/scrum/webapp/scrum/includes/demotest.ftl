...
<table>
    ...
    <tr>
        <td>
        <a href="/scrum/control/main?USERNAME=scrumadmin&PASSWORD=ofbiz&JavaScriptEnabled=Y" class="button tiny">Scrum Admin</a><br/>
        </td>
        <td>
            <b>Scrum Admin</b><br/>
    ...
    <tr>
        <td>
        <a href="/scrum/control/main?USERNAME=scrummaster&PASSWORD=ofbiz&JavaScriptEnabled=Y" class="button tiny">Scrum Master</td>
        <td>
            <b>Scrum Master</b><br/>
    ...
    <tr>
        <td>
        <a href="/scrum/control/main?USERNAME=productowner&PASSWORD=ofbiz&JavaScriptEnabled=Y" class="button tiny">Product Owner</a><br/>
        <a href="/scrum/control/main?USERNAME=productowner2&PASSWORD=ofbiz&JavaScriptEnabled=Y" class="button tiny">Product Owner2</a><br/>
        </td>
        <td>
    ...
    <tr>
        <td>
        <a href="/scrum/control/main?USERNAME=scrumteam1&PASSWORD=ofbiz&JavaScriptEnabled=Y" class="button tiny">Scrumteam1</a><br/>
        <a href="/scrum/control/main?USERNAME=scrumteam2&PASSWORD=ofbiz&JavaScriptEnabled=Y" class="button tiny">Scrumteam2</a><br/>
        <a href="/scrum/control/main?USERNAME=scrumteam3&PASSWORD=ofbiz&JavaScriptEnabled=Y" class="button tiny">Scrumteam3</a><br/>
        <a href="/scrum/control/main?USERNAME=scrumteam4&PASSWORD=ofbiz&JavaScriptEnabled=Y" class="button tiny">Scrumteam4</a><br/>
        </td>
        <td>
            <b>Scrumteam</b><br/>
    ...
    <tr>
        <td>
        <a href="/scrum/control/main?USERNAME=testadmin&PASSWORD=ofbiz&JavaScriptEnabled=Y" class="button tiny">Testadmin</a>
        </td>
        <td>
            <b>Opentest</b><br/>
    ...
    <tr>
        <td>
        <a href="/scrum/control/main?USERNAME=DemoStakeholder&PASSWORD=ofbiz&JavaScriptEnabled=Y" class="button tiny">DemoStakeholder</a>
        </td>
        <td>
