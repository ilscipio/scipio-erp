                        ...
                        <@td>
                            <#if product?has_content>
                                ...
                                <#if product?has_content>
                                    ...
                                    <a href="<@ofbizInterWebappUrl>/catalog/control/EditProduct?productId=${product.productId}&amp;externalLoginKey=${requestAttributes.externalLoginKey!}</@ofbizInterWebappUrl>">${productName?default(product.productId)}</a>
                                </#if>
                            </#if>
                        </@td>
