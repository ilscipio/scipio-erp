...
<@section title="${uiLabelMap.PageTitleEditProductFeatures}">
  ...
  <#list productFeatureAndAppls as productFeatureAndAppl>
    ...
    <#assign curProductFeatureCategory = (productFeatureAndAppl.getRelatedOne("ProductFeatureCategory", true)!)>
        <@tr id="productFeatureId_tableRow_${productFeatureAndAppl_index}" valign="middle">
          <@td>
            ...
            <a href="<@ofbizUrl>EditFeature?productFeatureId=${(productFeatureAndAppl.productFeatureId)!}</@ofbizUrl>" class="${styles.link_record_id!}">
          ...
          <@td><a href="<@ofbizUrl>EditFeatureCategoryFeatures?productFeatureCategoryId=${(productFeatureAndAppl.productFeatureCategoryId)!}&amp;productId=${(productFeatureAndAppl.productId)!}</@ofbizUrl>" class="${styles.link_record_desc!}">
    ...
    <#if (productFeatureAndAppl.getTimestamp("thruDate"))?? && Static["org.ofbiz.base.util.UtilDateTime"].nowTimestamp().after(productFeatureAndAppl.getTimestamp("thruDate"))> <#assign hasExpired = true></#if>
          ...
          <@td>
            <a href="javascript:document.RemoveFeatureFromProduct_o_${productFeatureAndAppl_index}.submit()" class="${styles.link_action!}">${uiLabelMap.CommonDelete}</a>
          </@td>
        </@tr>
  </#list>
        </@tbody>
