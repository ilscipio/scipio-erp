...
-->
<#if miniProduct??>
    <a href="<@ofbizCatalogAltUrl productId=miniProduct.productId/>" class="${styles.link_nav_info_name!}">${miniProductContentWrapper.get("PRODUCT_NAME", "html")?default("No Name Available")}</a>
    <ul>
