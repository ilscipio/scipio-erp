...
<#macro progress_markup value=0 id="" class="" showValue=false containerClass="" color="" origArgs={} extraArgs...>
...
<#macro field_markup_container type="" class="" columns="" postfix=false postfixSize=0 postfixContent=true labelArea=true labelType="" labelPosition="" labelAreaContent="" collapse="" collapseLabel="" collapsePostfix="" norows=false nocells=false container=true origArgs={} extraArgs...>
  <#local rowClass = "">
...
<#-- @field label area markup - theme override 
    ...
    WARN: origArgs may be empty -->
<#macro field_markup_labelarea labelType="" labelPosition="" label="" labelDetail="" fieldType="" fieldId="" collapse="" required=false origArgs={} extraArgs...>
