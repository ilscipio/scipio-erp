...
<div id="subsites"></div>
<#if (!subsites?has_content)>
    <a href="javascript:void(0);" class="${styles.link_nav!} ${styles.action_add!}">${uiLabelMap.ContentWebSiteAddTree}</a>
</#if>
<div>
...
<div id="menus"></div>
<#if (!menus?has_content)>
    <a href="javascript:void(0);" class="${styles.link_nav!} ${styles.action_add!}">${uiLabelMap.ContentWebSiteAddMenu}</a>
</#if>
...
<div id="errors"></div>
<#if (!errors?has_content)>
    <a href="javascript:void(0);" class="${styles.link_nav!} ${styles.action_add!}">${uiLabelMap.ContentWebSiteAddError}</a>
</#if>
