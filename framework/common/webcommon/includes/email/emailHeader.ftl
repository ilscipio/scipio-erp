                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <#if logoImageUrl?has_content>
                                                            <@img width="200" height="50" src="${rawString(baseSecureUrl)}${rawString(logoImageUrl)}"/>
                                                        <#else>
                                                            <#if baseSecureUrl?has_content>
                                                                <@img width="200" height="50" src="${rawString(baseSecureUrl)}/images/scipio/scipio-logo.png"/>
                                                            <#else>
