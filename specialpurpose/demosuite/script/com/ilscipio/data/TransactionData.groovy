...
public class TransactionData extends DataGeneratorGroovyBaseScript {
    ...
    private final static Map<String, List<String>> glExpenseAccountClassIds = [
        "EXPENSE" : [
            "513000",
            "513100",
            "513200",
    ...
    // AcctgTransTypeId
    private final static List<String> acctgTransTypeIds = [
        "AMORTIZATION",
        "CAPITALIZATION",
        "CREDIT_LINE",
        "CREDIT_MEMO",
    ...
    private final static Map<String, List<String>> glIncomeAccountClassIds = [
        "INCOME" : ["800000"],
        "CASH_INCOME" : [
            "801000",
            "802000",
...
//                Debug.log("debit acctg entry");
                ...
                if (incomeExpense == 1) {
                    ...
                    i = UtilRandom.random(keys);
                    glAccountClassIdList = glExpenseAccountClassIds.get(keys.get(i));
                } else {
                    keys = new ArrayList(glIncomeAccountClassIds.keySet());
                    i = UtilRandom.random(keys);
                    glAccountClassIdList = glIncomeAccountClassIds.get(keys.get(i));
                }
