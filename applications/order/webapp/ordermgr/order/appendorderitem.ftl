    ...
    <@cell class="${style_grid_large!}6 columns">
        <form method="post" action="<@ofbizUrl>appendItemToOrder</@ofbizUrl>" name="appendItemForm">
            ...
            <table class="basic-table" cellspacing="0">
              <#if catalogCol?has_content && (catalogCol?size > 1)>
                <tr>
                  <td scope="row" class="${style_grid_large!}3">${uiLabelMap.ProductChooseCatalog}</td>
                ...
                <tr>
                  <td scope="row" class="${style_grid_large!}3">${uiLabelMap.ProductProductId}</td>
                  <td>
                      ...
                      <#if "PURCHASE_ORDER" == orderHeader.orderTypeId>
                          <a href="javascript:quicklookup(document.appendItemForm.orderId)" class="${styles.button_default!}">${uiLabelMap.OrderQuickLookup}</a>
                      </#if>
                  </td>
                </tr>
                <tr>
                  <td scope="row" class="${style_grid_large!}3">${uiLabelMap.OrderPrice}</td>
                  <td>
                ...
                <tr>
                  <td scope="row" class="${style_grid_large!}3">${uiLabelMap.OrderQuantity}</td>
                  <td><input type="text" size="6" name="quantity" value="${requestParameters.quantity?default("1")}"/></td>
                </tr>
              <#if (shipGroups?size > 1)>
                <tr>
                  <td scope="row" class="${style_grid_large!}3">${uiLabelMap.OrderShipGroup}</td>
                ...
                <tr>
                  <td scope="row" class="${style_grid_large!}3">${uiLabelMap.OrderDesiredDeliveryDate}</td>
                  <td>
                ...
                <tr>
                  <td scope="row" class="${style_grid_large!}3">${uiLabelMap.OrderReturnReason}</td>
                  <td>
                ...
                <tr>
                  <td scope="row" class="${style_grid_large!}3">${uiLabelMap.OrderOrderItemType}</td>
                  <td>
                ...
                <tr>
                  <td scope="row" class="${style_grid_large!}3">${uiLabelMap.CommonComment}</td>
                  <td>
