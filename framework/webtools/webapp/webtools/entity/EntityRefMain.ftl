                ...
                <@table type="data-list" width="95%" border="1" cellpadding="2" cellspacing="0"> <#-- orig: class="" -->
                    <@tr class='entityheader'>
                        <@td colspan="5">
                            ...
                            <div>${entity.title}&nbsp;
                                <#if !forstatic>
                                    <a target="main" href="<@ofbizUrl>FindGeneric?entityName=${entity.entityName}&amp;find=true&amp;VIEW_SIZE=${getPropertyValueOrNull("webtools", "webtools.record.viewSize.default")!50}&amp;VIEW_INDEX=0</@ofbizUrl>">[${uiLabelMap.WebtoolsViewData}]</a>
                                </#if>
                                <#if !forstatic>
