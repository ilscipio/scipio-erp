...
<#macro nav_markup type="" id="" class="" style="" activeElem="" origArgs={} passArgs={} catchArgs...>
  <#switch type>
    <#case "magellan">
      <div data-magellan-expedition="fixed"<#if id?has_content> id="${escapePart(id, 'html')}</#if><#if style?has_content> style="${style}</#if>>
    ...
    <#case "breadcrumbs">
      ...
      <ul<@compiledClassAttribStr class=class /><#if id?has_content> id="${escapePart(id, 'html')}</#if><#if style?has_content> style="${style}</#if>>
        <#nested>
      </ul>
    <#break>
    <#case "steps">
...
<#macro menu_markup type="" specialType="" class="" id="" style="" attribs={} excludeAttribs=[] 
  ...
  <#if !inlineItems && htmlwrap?has_content>
    ...
    <#if htmlwrap?has_content><${htmlwrap}<@compiledClassAttribStr class=class /><#if id?has_content> id="${escapePart(id, 'html')}"</#if><#if style?has_content> style="${style}"</#if><#if attribs?has_content><@commonElemAttribStr attribs=attribs exclude=excludeAttribs/></#if>></#if>
  </#if>
      <#nested>
  <#if !inlineItems && htmlwrap?has_content>
    <#if specialType == "main">
...
<#macro menuitem_markup type="" menuType="" menuSpecialType="" class="" id="" style="" attribs={} 
  ...
  <#if !inlineItem && htmlwrap?has_content>
    <${htmlwrap}<@compiledClassAttribStr class=class /><#if id?has_content> id="${escapePart(id, 'html')}"</#if><#if style?has_content> style="${style}"</#if><#if attribs?has_content><@commonElemAttribStr attribs=attribs exclude=["class", "id", "style"]/></#if>><#rt>
  </#if>
      <#nested><#t>
  <#if !inlineItem && htmlwrap?has_content>
    </${htmlwrap}><#lt>
...
<#macro menuitem_link_markup itemType="" menuType="" menuSpecialType="" class="" id="" style="" href="" name="" onClick="" target="" title="" 
    ...
    origArgs={} passArgs={} catchArgs...>
  <#t><a href="${escapeFullUrl(href, 'html')}"<#if onClick?has_content> onclick="${escapePart(onClick, 'html')}"</#if><@compiledClassAttribStr class=class /><#if id?has_content> id="${escapePart(id, 'html')}"</#if><#if name?has_content> name="${name}"</#if><#if style?has_content> style="${style}"</#if><#if attribs?has_content><@commonElemAttribStr attribs=attribs exclude=excludeAttribs/></#if><#if target?has_content> target="${escapePart(target, 'html')}"</#if><#if title?has_content> title="${escapePart(title, 'html')}"</#if>><#nested></a>
</#macro>
...
<#macro menuitem_text_markup itemType="" menuType="" menuSpecialType="" contentWrapElem=true class="" id="" style="" onClick="" attribs={} excludeAttribs=[] 
  ...
  <#t><#if contentWrapElem?has_content><${contentWrapElem}<@compiledClassAttribStr class=class /><#if id?has_content> id="${escapePart(id, 'html')}"</#if><#if style?has_content> style="${style}"</#if><#if attribs?has_content><@commonElemAttribStr attribs=attribs exclude=excludeAttribs/></#if><#if onClick?has_content> onclick="${escapePart(onClick, 'html')}"</#if>></#if><#nested><#if contentWrapElem?has_content></${contentWrapElem}></#if>
</#macro>
...
<#macro menuitem_submit_markup itemType="" menuType="" menuSpecialType="" class="" id="" style="" text="" onClick="" disabled=false attribs={} 
    ...
    origArgs={} passArgs={} catchArgs...>
  <#t><button type="submit"<@compiledClassAttribStr class=class /><#if id?has_content> id="${escapePart(id, 'html')}"</#if><#if style?has_content> style="${style}"</#if><#if attribs?has_content><@commonElemAttribStr attribs=attribs exclude=excludeAttribs/></#if><#if onClick?has_content> onclick="${escapePart(onClick, 'html')}"</#if><#if disabled> disabled="disabled"</#if>/><#nested></button>
</#macro>
