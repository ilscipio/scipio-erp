...
-->
        <form action="<@ofbizUrl>DuplicateWorkEffort</@ofbizUrl>" method="post">
            ...
            <div>
                ...
                <input type="text" size="20" maxlength="20" name="workEffortId"/>&nbsp;<input type="submit" class="${styles.link_action_sys!} ${styles.action_copy!}" value="${uiLabelMap.CommonDuplicate}!"/>
            </div>
            <div>
