...
<form name="advtokeywordsearchform" method="post" action="<@ofbizUrl>keywordsearch</@ofbizUrl>" style="margin: 0;">
  ...
  <@table type="fields" cellspacing="" border="0" width="100%">
    ...
    <#if searchCategory?has_content>
        ...
        <@tr>
          <@td align="right" valign="middle">${uiLabelMap.ProductCategory}:</@td>
          <@td valign="middle">
    ...
    <@tr>
      <@td align="right" valign="middle">${uiLabelMap.ProductKeywords}:</@td>
      <@td valign="middle">
    ...
    <#list productFeatureTypeIdsOrdered as productFeatureTypeId>
      ...
      <@tr>
        <@td align="right" valign="middle">${(productFeatureType.get("description",locale))!}:</@td>
        <@td valign="middle">
    ...
    <@tr>
      <@td align="right" valign="middle">${uiLabelMap.ProductSupplier}:</@td>
      <@td valign="middle">
  ...
  <#if searchOptionsHistoryList?has_content>
    ...
    <#-- searchOptions type is ProductSearchSession.ProductSearchOptions -->
        <div>
          ...
          <a href="<@ofbizUrl>setCurrentSearchFromHistoryAndSearch?searchHistoryIndex=${searchOptions_index}&amp;clearSearch=N</@ofbizUrl>" class="${styles.button_default!}">${uiLabelMap.CommonSearch}</a>
          <a href="<@ofbizUrl>setCurrentSearchFromHistory?searchHistoryIndex=${searchOptions_index}</@ofbizUrl>" class="${styles.button_default!}">${uiLabelMap.CommonRefine}</a>
        </div>
