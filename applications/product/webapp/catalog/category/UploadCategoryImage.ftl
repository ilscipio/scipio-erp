...
<#--    </@section>-->
    ...
    <@section title=uiLabelMap.ProductCategoryUploadImage>
        ...
        <form method="post" enctype="multipart/form-data" action="<@pageUrl>UploadCategoryImage?productCategoryId=${productCategoryId}&amp;upload_file_type=original</@pageUrl>" name="imageUploadForm">
            <@fields type="default-nolabelarea">
                <@fields type="default">
                    <@cataloglib.imageProfileSelect fieldName="imageProfile" profileName=(parameters.mediaProfile!productCategory.imageProfile!"") defaultProfileName="IMAGE_CATEGORY-ORIGINAL_IMAGE_URL" parentProfile="IMAGE_CATEGORY"/>
                </@fields>
                <@field type="file" size="50" name="fname"/>
                <@field type="generic">
                    <@field type="radio" name="upload_file_type_bogus" value="small" onClick="setUploadUrl('${escapeVal(makePageUrl('UploadCategoryImage?productCategoryId=${productCategoryId}&upload_file_type=small'), 'js')}');" label=uiLabelMap.CommonSmall/>
                    <@field type="radio" name="upload_file_type_bogus" value="medium" onClick="setUploadUrl('${escapeVal(makePageUrl('UploadCategoryImage?productCategoryId=${productCategoryId}&upload_file_type=medium'), 'js')}');" label=uiLabelMap.CommonMedium/>
                    <@field type="radio" name="upload_file_type_bogus" value="large" onClick="setUploadUrl('${escapeVal(makePageUrl('UploadCategoryImage?productCategoryId=${productCategoryId}&upload_file_type=large'), 'js')}');" label=uiLabelMap.CommonLarge/>
                    <@field type="radio" name="upload_file_type_bogus" value="detail" onClick="setUploadUrl('${escapeVal(makePageUrl('UploadCategoryImage?productCategoryId=${productCategoryId}&upload_file_type=detail'), 'js')}');" label=uiLabelMap.CommonDetail/>
                    <@field type="radio" name="upload_file_type_bogus" value="original" checked=true onClick="setUploadUrl('${escapeVal(makePageUrl('UploadCategoryImage?productCategoryId=${productCategoryId}&upload_file_type=original'), 'js')}');" label=uiLabelMap.ProductOriginal/>
                </@field>
