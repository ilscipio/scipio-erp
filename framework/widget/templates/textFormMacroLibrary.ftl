...
<#macro makeHyperlinkString linkStyle hiddenFormName event action imgSrc alternate linkUrl targetWindow description extraArgs...><@renderField description /></#macro>
