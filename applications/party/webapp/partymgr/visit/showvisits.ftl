      ...
      <@table type="data-list" autoAltRows=true class="+hover-bar" cellspacing="0"> <#-- orig: class="basic-table hover-bar" -->
       <@thead>
        ...
        <#list visitList as visitObj>
          <@tr>
            <@td class="button-col"><a href="<@ofbizUrl>visitdetail?visitId=${visitObj.visitId}</@ofbizUrl>" class="${styles.link_id!}">${visitObj.visitId}</a></@td>
            <@td>${visitObj.visitorId!}</@td>
            <@td class="button-col"><a href="<@ofbizUrl>viewprofile?partyId=${visitObj.partyId!}</@ofbizUrl>" class="${styles.link_id!}">${visitObj.partyId!}</a></@td>
