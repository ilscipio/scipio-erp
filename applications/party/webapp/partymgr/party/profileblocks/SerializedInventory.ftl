        ...
        <@table type="data-list" id="serialized-inventory" cellspacing="0" cellpadding="2"> <#-- orig: class="basic-table" -->
            ...
            <@tbody>
                <#list inventoryItemList as inventoryItem>
                    ...
                    <@tr>
                        <@td><a href="/facility/control/EditInventoryItem?inventoryItemId=${inventoryItem.inventoryItemId}&amp;externalLoginKey=${requestAttributes.externalLoginKey!}" class="${styles.link_record_id!}">${inventoryItem.inventoryItemId}</a></@td>
                        <@td>
