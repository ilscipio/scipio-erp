...
under the License.
-->
<div id="params_taskByStatusReport" style="display:none">
...
<@script>
    ...
    formObj.action = "/birt/preview?__page=2&__report=component://scrum/webapp/scrum/reports/TaskByStatusChart.rptdesign&__masterpage=true&__format=html";
    formObj.target = "taskByStatusReport";
    formObj.submit( );
    }
</@script>
