...
<#assign sectionTitle>
    <@row>
        <@cell small=10>
            <@heading>${uiLabelMap.OrderReturnFromOrder} ${uiLabelMap.CommonNbr} <a href="<@ofbizUrl>orderview?orderId=${orderId}</@ofbizUrl>" class="${styles.link_record_id!}">${orderId}</a></@heading>
        </@cell>
        <@cell small=2>
...
<#if returnableItems?has_content>
  <#assign sectionTitle>${uiLabelMap.OrderReturnAdjustments} ${uiLabelMap.CommonNbr} <a href="<@ofbizUrl>orderview?orderId=${orderId}</@ofbizUrl>" class="${styles.link_record_id!}">${orderId}</a></#assign>
  ...
  <#assign sectionTitle>${uiLabelMap.OrderReturnManualAdjustment} ${uiLabelMap.CommonNbr} <a href="<@ofbizUrl>orderview?orderId=${orderId}</@ofbizUrl>" class="${styles.link_record_id!}">${orderId}</a></#assign>
  <@section title=sectionTitle>
        <@table type="data-list">
          <@thead>
          <@tr type="meta" class="header-row">
