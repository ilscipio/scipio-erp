  ...
  <@table type="fields" class="+${styles.table_hint_spacing_small!}" border="0" width="100%"> <#-- orig: class="" --> <#-- orig: cellspacing="" -->
    ...
    <@tr>
      <@td width="100%" align="center" colspan="2">
        ...
        <a id="removeCheckTotalPaid" href="javascript:void(0);" class="${styles.link_type_image!} ${styles.action_run_sys!} ${styles.action_remove!}"><img src="/images/collapse.gif"/></a>
      </@td>
    </@tr>
    <@tr>
    ...
    <@tr>
      <@td colspan="2" align="center">
        <input type="submit" value="${uiLabelMap.CommonConfirm}" id="payCheckConfirm" class="${styles.link_run_sys!} ${styles.action_update!}"/>
        <input type="submit" value="${uiLabelMap.CommonCancel}" id="payCheckCancel" class="${styles.link_nav_cancel!}"/>
      </@td>
    </@tr>
    <@tr>
