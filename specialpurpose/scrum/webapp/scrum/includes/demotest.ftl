...
<@table type="data-list" class="+${styles.table_spacing_tiny_hint!}"> <#-- orig: class="" --> <#-- orig: cellspacing="" -->
    ...
    <@tr>
        <@td>
        <a href="<@ofbizInterWebappUrl>/scrum/control/main?USERNAME=scrumadmin&PASSWORD=ofbiz&JavaScriptEnabled=Y</@ofbizInterWebappUrl>" class="${styles.link_nav!}">Scrum Admin</a><br/>
        </@td>
        <@td>
            <b>Scrum Admin</b><br/>
    ...
    <@tr>
        <@td>
        <a href="<@ofbizInterWebappUrl>/scrum/control/main?USERNAME=scrummaster&PASSWORD=ofbiz&JavaScriptEnabled=Y</@ofbizInterWebappUrl>" class="${styles.link_nav!}">Scrum Master</@td>
        <@td>
            <b>Scrum Master</b><br/>
    ...
    <@tr>
        <@td>
        <a href="<@ofbizInterWebappUrl>/scrum/control/main?USERNAME=productowner&PASSWORD=ofbiz&JavaScriptEnabled=Y</@ofbizInterWebappUrl>" class="${styles.link_nav!}">Product Owner</a><br/>
        <a href="<@ofbizInterWebappUrl>/scrum/control/main?USERNAME=productowner2&PASSWORD=ofbiz&JavaScriptEnabled=Y</@ofbizInterWebappUrl>" class="${styles.link_nav!}">Product Owner2</a><br/>
        </@td>
        <@td>
    ...
    <@tr>
        <@td>
        <a href="<@ofbizInterWebappUrl>/scrum/control/main?USERNAME=scrumteam1&PASSWORD=ofbiz&JavaScriptEnabled=Y</@ofbizInterWebappUrl>" class="${styles.link_nav!}">Scrumteam1</a><br/>
        <a href="<@ofbizInterWebappUrl>/scrum/control/main?USERNAME=scrumteam2&PASSWORD=ofbiz&JavaScriptEnabled=Y</@ofbizInterWebappUrl>" class="${styles.link_nav!}">Scrumteam2</a><br/>
        <a href="<@ofbizInterWebappUrl>/scrum/control/main?USERNAME=scrumteam3&PASSWORD=ofbiz&JavaScriptEnabled=Y</@ofbizInterWebappUrl>" class="${styles.link_nav!}">Scrumteam3</a><br/>
        <a href="<@ofbizInterWebappUrl>/scrum/control/main?USERNAME=scrumteam4&PASSWORD=ofbiz&JavaScriptEnabled=Y</@ofbizInterWebappUrl>" class="${styles.link_nav!}">Scrumteam4</a><br/>
        </@td>
        <@td>
            <b>Scrumteam</b><br/>
    ...
    <@tr>
        <@td>
        <a href="<@ofbizInterWebappUrl>/scrum/control/main?USERNAME=testadmin&PASSWORD=ofbiz&JavaScriptEnabled=Y</@ofbizInterWebappUrl>" class="${styles.link_nav!}">Testadmin</a>
        </@td>
        <@td>
            <b>Opentest</b><br/>
    ...
    <@tr>
        <@td>
        <a href="<@ofbizInterWebappUrl>/scrum/control/main?USERNAME=DemoStakeholder&PASSWORD=ofbiz&JavaScriptEnabled=Y</@ofbizInterWebappUrl>" class="${styles.link_nav!}">DemoStakeholder</a>
        </@td>
        <@td>
