...
<div class="button-bar">
  <a href="<@ofbizUrl>EditWorkEffort?workEffortTypeId=TASK&amp;currentStatusId=CAL_NEEDS_ACTION</@ofbizUrl>" class="${styles.button_default!} create">${uiLabelMap.WorkEffortNewTask}</a>
</div>
