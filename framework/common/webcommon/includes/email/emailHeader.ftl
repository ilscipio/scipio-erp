                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <#if logoImageUrl?has_content>
                                                            <@img width="200" height="50" src=makeOfbizContentUrl(logoImageUrl)/>
                                                        <#else>
                                                            <#-- This test is invalid (baseUrl/baseSecureUrl should be avoided in templates, never made sense), and 
                                                                the makeOfbizContentUrl will warn in log if the prefix is missing, which means insufficient configuration for emails
                                                            <#if baseSecureUrl?has_content>-->
                                                            <@img width="200" height="50" src=makeOfbizContentUrl("/images/scipio/scipio-logo.png")/>
                                                            <#--<#else>
