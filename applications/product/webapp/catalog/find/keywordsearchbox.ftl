...
<form name="keywordsearchform" id="keywordSearchForm" method="post" action="<@ofbizUrl>keywordsearch?VIEW_SIZE=25&amp;PAGING=Y</@ofbizUrl>">
  <fieldset>
    ...
    <div>
      <input type="submit" name="find" value="${uiLabelMap.CommonFind}" class="${styles.button_default!}" />
    </div>
    </fieldset>
</form>
<form name="advancedsearchform" id="advancedSearchForm" method="post" action="<@ofbizUrl>advancedsearch</@ofbizUrl>">
  <fieldset>
    ...
    <div>
    <a href="javascript:document.getElementById('advancedSearchForm').submit()" class="${styles.button_default!}">${uiLabelMap.ProductAdvancedSearch}</a>
    </div>
  </fieldset>
</form>
<form name="productjumpform" id="productJumpForm" method="post" action="<@ofbizUrl>EditProduct</@ofbizUrl>">
  <fieldset>
    ...
    <@input type="select" name="DUMMYPAGE" id="dummyPage" onchange="submitProductJump()">
