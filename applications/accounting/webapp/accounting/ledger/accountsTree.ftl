...
<@script>
if (typeof ScpTreeHandler === 'undefined') {
    /**
     * GlAccount tree handler constructor.
     */
    function ScpTreeHandler(data) { // TODO?: this object could go in js file
                        ...
                        <#list accountMaps as account>
                            <#if account.parentGlAccountId?has_content>
                                ...
                                <@treeitem text="${account.accountCode!} ${account.accountName!}" id=account.glAccountId!  parent=(account.parentGlAccountId!"#") 
                                    attribs={"data":{
                                    	"type":"${account.glAccountTypeId!}",
                                    	"class":"${account.glAccountClassId!}",
