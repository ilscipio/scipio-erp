  ...
  <@tr>
    <@td valign="top" width="0">
      ...
      <#if productLargeImageUrl?string?has_content>
        <a href="javascript:popupDetail();" class="${styles.link_type_image!} ${styles.action_run_sys!} ${styles.action_view!}"><img src="<@ofbizContentUrl>${contentPathPrefix!}${productLargeImageUrl!}</@ofbizContentUrl>" name="mainImage" vspace="5" hspace="5" class="cssImgLarge" alt="" /></a>
      </#if>
    </@td>
          ...
          <#if inStock>
            ...
            <#if (product.productTypeId!) == "ASSET_USAGE" || (product.productTypeId!) == "ASSET_USAGE_OUT_IN">
              <@fields type="default-manual-widgetonly">
                ...
                <@tr>
                    <@td><@field type="datetime" name="reservStart" size="25" maxlength="30" id="startDate1" /></@td>
                    <@td><@field type="datetime" name="reservEnd" size="25" maxlength="30" id="endDate1" /></@td>
                </@tr>
                <@tr>
                  ...
                  <#if (product.reservMaxPersons!)?is_number>  
                    ...
                    <@td><@field type="input" size="4" name="reservPersons" value="2"/></@td>
                  </#if>
                    <@td nowrap="nowrap" align="right">Quantity</@td>
                    <@td><@field type="input" size="5" name="quantity" value="1"/></@td>
                </@tr>
                </@table>
              </@fields>
            <#else>
      ...
      <#if variantSample?? && (0 < variantSample.size())>
        ...
        <@table type="data-complex"> <#-- orig: cellspacing="0" --> <#-- orig: cellpadding="0" -->
          <@tr>
            ...
            <#list imageKeys as key>
              ...
              <#if swatchProduct?has_content && indexer < maxIndex>
                ...
                <@td align="center" valign="bottom">
                  <a href="javascript:getList('FT${featureOrderFirst}','${indexer}',1);" class="${styles.link_type_image!} ${styles.action_run_local!} ${styles.action_select!}"><img src="<@ofbizContentUrl>${contentPathPrefix!}${imageUrl}</@ofbizContentUrl>" class="cssImgSmall" alt="" /></a>
                  <br />
            ...
            <#if (indexer > maxIndex)>
              <@td><b>${uiLabelMap.ProductMoreOptions}</b></@td>
            </#if>
          </@tr>
        </@table>
      </#if>
