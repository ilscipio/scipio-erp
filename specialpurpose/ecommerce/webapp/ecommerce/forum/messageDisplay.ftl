...
-->
        ...
        <#else>
            ...
            <div class="tableheadtext">
                ...
                <a href="ViewForumMessage?forumId=${parameters.forumId}&amp;responseContentId=${forumMessage.contentId}&amp;threadContentId=${threadContentId!}" class="${styles.button_default!}">${uiLabelMap.CommonView}</a>
            </div>
            <div class="tableheadtext">
        ...
        <#--
          ...
          <#if (result.resultData)??>
            <div class="tableheadtext">
                ...
                <a href="addForumMessage?forumId=${parameters.forumId}&amp;forumMessageIdTo=${result.resultData.content.contentId}&amp;threadView=${parameters.threadView!}" class="${styles.button_default!}">${uiLabelMap.PartyReply}</a>
            </div>
            <div>
