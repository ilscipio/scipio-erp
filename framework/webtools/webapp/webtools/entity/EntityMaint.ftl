...
<@cell columns=6>
       ...
       <form action="<@ofbizUrl>/entitymaint</@ofbizUrl>">
        ...
        <@field type="submitarea">  
          <input type="submit" value="${uiLabelMap.CommonApply}" class="${styles.link_run_sys!} ${styles.action_find!}"/>
        </@field>
       </form>
</@cell>
</@row> 
   ...
   <@cell>
    ...
    <#assign right_col = false>
      ...
      <#list entitiesList as entity>
        ...
        <#assign firstChar = "*">
        <@table type="data-complex" autoAltRows=false class="+hover-bar" cellspacing="0"> <#-- orig: class="basic-table hover-bar" -->
          <@thead>
          <@tr class="header-row">
            ...
            <@td class="button-col">
              <#if entity.viewEntity == 'Y'>
                <#if entity.entityPermissionView == 'Y'>
                  ...
                  <a href="<@ofbizUrl>FindGeneric?entityName=${entity.entityName}&amp;find=true&amp;VIEW_SIZE=${getPropertyValueOrNull("webtools", "webtools.record.viewSize.default")!50}&amp;VIEW_INDEX=0</@ofbizUrl>">${uiLabelMap.WebtoolsAll}</a>
                </#if>
              <#else>
                ...
                <#if entity.entityPermissionView == 'Y'>
                  ...
                  <a href="<@ofbizUrl>FindGeneric?entityName=${entity.entityName}&amp;find=true&amp;VIEW_SIZE=${getPropertyValueOrNull("webtools", "webtools.record.viewSize.default")!50}&amp;VIEW_INDEX=0</@ofbizUrl>" title="${uiLabelMap.WebtoolsFindAllRecords}">${uiLabelMap.WebtoolsAll}</a>
                </#if>
              </#if>
            </@td>
            <#if right_col>
