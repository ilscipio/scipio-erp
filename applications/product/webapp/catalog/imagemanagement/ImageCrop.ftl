...
if (imageName != "") {
    ...
    jQuery('#ImageCropping tbody').append("<tr><td><input type='submit' value='${uiLabelMap.CommonSubmit}' name='submitButton' class='smallSubmit ${styles.button_default!}'/></td></tr>");
