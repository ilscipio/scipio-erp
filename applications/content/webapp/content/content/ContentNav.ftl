      ...
      <#macro fillTree assocList>
          <#if (assocList?has_content)>
            <#list assocList as assoc>
                <#assign content  = delegator.findOne("Content",{"contentId":assoc.contentIdTo}, false)/>
                {
                ...
                <#assign assocChilds  = delegator.findByAnd("ContentAssoc",{"contentId":assoc.contentIdTo, "contentAssocTypeId":"TREE_CHILD"}, null, false)/>
