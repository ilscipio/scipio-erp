...
public abstract class ContentImageWorker {
    ...
    /**
     * Core image file resizing method.
     * See contentImageFileScaleInAllSizeCore service interface for context params.
     */
    public static Map<String, Object> imageFileScaleInAllSizeCore(Delegator delegator, Map<String, ?> context) {
        ...
        Map<String, Object> imagePathArgs = UtilGenerics.checkMap("imagePathArgs");
        ...
        final String origSizeType = ORIGINAL_SIZETYPE;
...
//                            }
    ...
    /**
     * Core database image resizing method.
     * See contentImageDbScaleInAllSizeCore service interface for context params.
     */
    public static Map<String, Object> imageDbScaleInAllSizeCore(Delegator delegator, Map<String, ?> context) {
