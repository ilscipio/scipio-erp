...
public interface BasicSectionsRenderer {
     ...
     * */
    String render(String sectionName, boolean asString) throws GeneralException, IOException;
    
    /** 
     * This is a lot like the ScreenRenderer class and returns an empty String so it can be used more easily with FreeMarker 
     */
    String render(String sectionName) throws GeneralException, IOException;
    
    /** 
     * SCIPIO: version which scopes by default by pushing context stack (shareScope FALSE).
     */
    String renderScoped(String sectionName, Boolean asString, Boolean shareScope) throws GeneralException, IOException;
    
    /** 
     * SCIPIO: version which scopes by default by pushing context stack (shareScope FALSE),
     * generic object/ftl-friendly version.
     */
    String renderScopedGen(String sectionName, Object asString, Object shareScope) throws GeneralException, IOException;
