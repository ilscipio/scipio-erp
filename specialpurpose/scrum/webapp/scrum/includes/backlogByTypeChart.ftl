...
<script type="text/javascript">
    ...
    formObj.action = "/birt/preview?__page=2&__report=component://scrum/webapp/scrum/reports/BacklogByTypeChart.rptdesign&__masterpage=true&__format=html";
    formObj.target = "byTypeReport";
    formObj.submit( );
    }
</script>
