          ...
          <#if (configEntry.specialType!)=="eca-toggle">
            ...
            <@fields type="default-compact">
              <@field type="select" name="value" inline=true>
                <option value=""<#if !configEntry.dbValue!?is_boolean> selected="selected"</#if>><#if !configEntry.dbValue!?is_boolean>${configEntry.value!?string} (current - non-DB)<#else>(clear DB)</#if></option>
                <option value="true"<#if configEntry.dbValue!?is_boolean && configEntry.dbValue> selected="selected"</#if>>true (DB)</option>
                <option value="false"<#if configEntry.dbValue!?is_boolean && !configEntry.dbValue> selected="selected"</#if>>false (DB)</option>
              </@field>
