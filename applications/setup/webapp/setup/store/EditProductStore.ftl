...
<@section>
    ...
    <#assign storeFixedParams = fixedParams>
          ...
          <#else>
            ...
            <@field type="input" name="storeName" label=uiLabelMap.ProductStoreName required=true size="30" maxlength="60" value=(params.storeName!"${partyGroup.groupName!} ${uiLabelMap.ProductProductStore} 1")/>
