                ...
                <@tr valign="middle">
                    <@td valign="top">
                            <#if showRequestManagementLinks??>
                                <a href="<@ofbizUrl>EditRequestItem?custRequestId=${requestItem.custRequestId}&amp;custRequestItemSeqId=${requestItem.custRequestItemSeqId}</@ofbizUrl>" class="${styles.link_record_id!}">${requestItem.custRequestItemSeqId}</a>
                            <#else>
                    ...
                    <@td valign="top">
                            ...
                            <#if showRequestManagementLinks??>
                                <a href="/catalog/control/EditProduct?productId=${requestItem.productId!}" class="${styles.link_record_id!}">${requestItem.productId!}</a>
                            <#else>
                                <a href="<@ofbizUrl>product?product_id=${requestItem.productId!}</@ofbizUrl>" class="${styles.link_record_id!}">${requestItem.productId!}</a>
                            </#if>
                        </@td>
