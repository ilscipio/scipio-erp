...
<#if cartLineIndex?? && cartLineIndex?has_content>
  ...
  <#if isInteger>
    ...
    <#if cartLine?? && cartLine?has_content>
      ...
      <a href="javascript:void(0);" id="incrementQuantity" class="${styles.link_type_image!} ${styles.action_run_session!} ${styles.action_add!}"><img src="/images/expand.gif"/></a>
      <a href="javascript:void(0);" id="decrementQuantity" class="${styles.link_type_image!} ${styles.action_run_session!} ${styles.action_remove!}"><img src="/images/collapse.gif"/></a>
      <br/>
      ...
      <a id="updateCartItem" name="updateCartItem" href="javascript:updateCartItem();" class="${styles.link_run_session!} ${styles.action_update!}">${uiLabelMap.CommonUpdate}</a>
      <a id="deleteCartItem" name="deleteCartItem" href="javascript:deleteCartItem('${cartLineIndex}');" class="${styles.link_run_session!} ${styles.action_remove!}">${uiLabelMap.CommonDelete}</a>
    </div>
    <@script>
