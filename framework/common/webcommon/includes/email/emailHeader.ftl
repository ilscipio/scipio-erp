                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <#if logoImageUrl?has_content>
                                                            <@img width="200" height="50" src=makeContentUrl(logoImageUrl)/>
                                                        <#else>
                                                            <#-- This test is invalid (baseUrl/baseSecureUrl should be avoided in templates, never made sense), and 
                                                                the makeContentUrl will warn in log if the prefix is missing, which means insufficient configuration for emails
                                                            <#if baseSecureUrl?has_content>-->
                                                            <@img width="200" height="50" src=makeContentUrl("/images/scipio/scipio-logo.png")/>
                                                            <#--<#else>
