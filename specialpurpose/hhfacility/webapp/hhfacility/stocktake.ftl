    ...
    <@table type="data-list" class="+${styles.table_spacing_tiny_hint!}"> <#-- orig: class="" --> <#-- orig: cellspacing="" -->
        <#list productList as product>
            <@tr>
                ...
                <@td>&nbsp;&nbsp;</@td>
                <@td>
                    <a href="<@ofbizUrl>productstocktake?facilityId=${facility.facilityId!}&amp;productId=${product.productId}</@ofbizUrl>" class="${styles.link_nav_info_name!}">${(product.internalName)!}</a>
                </@td>
            </@tr>
        </#list>
    </@table>
