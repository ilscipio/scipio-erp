...
<#macro renderFormOpen linkUrl formType targetWindow containerId containerStyle autocomplete name useRowSubmit showProgress=false progressSuccessAction=""></#macro>
