              ...
              <#if ((requestParameters.groupByShippingMethod?? && requestParameters.groupByShippingMethod == "Y") || (requestParameters.groupByWarehouseArea?? && requestParameters.groupByWarehouseArea == "Y") || (requestParameters.groupByNoOfOrderItems?? && requestParameters.groupByNoOfOrderItems == "Y"))>
                <@td>
                  ...
                  <#if groupName1?has_content>
                    <a href="javascript:document.viewGroupDetail_${pickMoveInfo_index}.submit()" class="${styles.link_record_name!}">${groupName1}</a>
                  </#if>
                </@td>
                <@td>
                  <#if groupName2?has_content>
                    <a href="javascript:document.viewGroupDetail_${pickMoveInfo_index}.submit()" class="${styles.link_record_name!}">${groupName2}</a>
                  </#if>
                </@td>
                <@td>
                  <#if groupName3?has_content>
                    <a href="javascript:document.viewGroupDetail_${pickMoveInfo_index}.submit()" class="${styles.link_record_name!}">${groupName3}</a>
                  </#if>
                </@td>
              <#else>
                <@td>
                  ${viewGroupDetailForm}
                  <a href="javascript:document.viewGroupDetail_${pickMoveInfo_index}.submit()" class="${styles.link_record_name!}">${groupName!}</a>
                </@td>
              </#if>
            <@td>
              <#if !((requestParameters.groupByShippingMethod?? && requestParameters.groupByShippingMethod == "Y") || (requestParameters.groupByWarehouseArea?? && requestParameters.groupByWarehouseArea == "Y") || (requestParameters.groupByNoOfOrderItems?? && requestParameters.groupByNoOfOrderItems == "Y"))>
      ...
      <@thead>
        ...
        <#list toPickList as toPick>
          ...
          <#list oiasgal as oiasga>
            ...
            <@tr valign="middle">
              <@td><a href="/ordermgr/control/orderview?orderId=${oiasga.orderId}${StringUtil.wrapString(externalKeyParam)}" class="${styles.link_record_id!}" target="_blank">${oiasga.orderId}</a></@td>
